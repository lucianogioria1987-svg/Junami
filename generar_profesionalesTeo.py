...
universidades = [
    "Universidad Nacional de Tucumán", "Universidad Favaloro", 
    "UBA", "Universidad Siglo 21", "Universidad del Norte Santo Tomás de Aquino"
]
calles = [
    "Av. Aconquija", "24 de Septiembre", "Muñecas", 
    "San Martín", "Laprida", "Av. Mate de Luna", "Corrientes"
]
...
def generar():
    ...
    # --- 3 PROFESIONALES (TITULARES) DE T.O. ---
    titulares_data = [
    ...
    for t in titulares_data:
        ...
        profesionales.append({
            ...
            "especialidad": "Terapia Ocupacional", # ¡CAMPO CRÍTICO AGREGADO!
    ...
    print(f"✅ Profesionales de TEO generados correctamente en '{ARCHIVO}'.")
